...
const API_URL = import.meta.env.VITE_API_URL || 'https://music-player-demo-production.up.railway.app/api';
 ...
 * @param {string} imageUrl - Base64 image string (optional)
 * @returns {Promise<Object>} Response with new playlist_id
 */
export async function createPlaylist(userId, name, description = '', colorHex = '#a855f7', imageUrl = '') {
  console.log('API: Creating playlist with image:', imageUrl ? `${imageUrl.substring(0, 50)}...` : 'No image');
